defmodule Escher.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Square Limit", Escher.Scene.SquareLimit},
           {"F", Escher.Scene.F},
           {"More F", Escher.Scene.MoreF},
           {"Man", Escher.Scene.Man},
           {"Fish", Escher.Scene.Fish},
           {"More Fish", Escher.Scene.MoreFish}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
